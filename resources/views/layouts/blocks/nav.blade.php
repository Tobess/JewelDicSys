<?php
    $navTree = [
        ...
        ['path'=>'/console/standard?mod=colors','title'=>'标准颜色','icon'=>'fa fa-tint'],
        ['path'=>'/console/standard?mod=certificates','title'=>'标准证书','icon'=>'glyphicon glyphicon-certificate'],
        ['path'=>'/console/standard?mod=clarities','title'=>'标准净度','icon'=>'glyphicon glyphicon-search'],
        ['path'=>'/console/standard?mod=cuts','title'=>'标准切工','icon'=>'glyphicon glyphicon-thumbs-up'],
        ['path'=>'/console/standard?mod=grades','title'=>'标准等级','icon'=>'fa fa-sort-numeric-desc'],
        ['path'=>'/console/standard?mod=shapes','title'=>'标准形状','icon'=>'glyphicon glyphicon-th'],
        '系统管理',
